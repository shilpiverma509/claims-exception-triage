...
- **T14 ⬜ S — Submission-ready checklist.** Repo pushed (Shilpi, Mon); no key/PHI in git history; tag v1.0; demo recorded ≤5 min; email drafted to both programme reviewers (addresses held privately) with subject "Cohort 5 Capstone package — Shilpi Verma", repo link, brief PDF/docx, recording link; DECISION_LOG complete; drill ledger empty.
